"""
Django settings for audiences project.
...
CSRF_COOKIE_SECURE = True  # make sure you're serving via HTTPS
SESSION_COOKIE_SECURE = True

CSRF_TRUSTED_ORIGINS = [
    "https://conversational-agent-482948542347.us-east1.run.app",
    "https://conversational-analytics-agent-482948542347.us-east1.run.app",
]
